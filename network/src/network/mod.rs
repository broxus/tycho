    ...
    for addr in socket_addrs {
        ...
        match socket.bind(&socket2::SockAddr::from(addr)) {
            ...
            Err(e) => {
                ...
                tracing::info!(%addr, "Failed to bind. Trying next address. Error: {e:?}",);
...
pub enum BindError {
    ...
    SocketCreation {
        addr: Option<SocketAddr>, /* Option because Domain::for_address might be before full addr resolution */
        #[source]
        source: std::io::Error,
    },
