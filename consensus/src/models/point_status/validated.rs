...
impl PointStatusStore for PointStatusValidated {
    ...
    fn status_flags(&self) -> StatusFlags {
        ...
        flags.set(StatusFlags::NoDagRound, self.no_dag_round);
    ...
    fn read(flags: StatusFlags, stored: &[u8]) -> anyhow::Result<Self> {
        ...
        Ok(Self {
            ...
            no_dag_round: flags.contains(StatusFlags::NoDagRound),
...
impl super::PointStatusStoreRandom for PointStatusValidated {
    fn random() -> Self {
        Self {
            is_valid: rand::random(),
            is_first_valid: rand::random(),
            is_first_resolved: rand::random(),
            has_proof: rand::random(),
            no_dag_round: rand::random(),
