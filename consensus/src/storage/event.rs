...
impl TlWrite for EventKey {
    ...
    where
        P: TlPacket,
    {
        packet.write_raw_slice(&self.time.millis().to_be_bytes());
...
pub enum EventKind {
    #[tl(id = "consensus.eventKind.nodeStarted")]
    NodeStarted,
    #[tl(id = "consensus.eventKind.unknownQuery")]
    UnknownQuery,
    #[tl(id = "consensus.eventKind.broadcastLimitReached")]
    BroadcastLimitReached,
    #[tl(id = "consensus.eventKind.sigRequestLimitReached")]
    SigRequestLimitReached,
    #[tl(id = "consensus.eventKind.uploadLimitReached")]
    UploadLimitReached,
    #[tl(id = "consensus.eventKind.illegalPoint")]
    IllegalPoint,
    #[tl(id = "consensus.eventKind.senderNotAuthor")]
    SenderNotAuthor,
    #[tl(id = "consensus.eventKind.illFormed")]
    IllFormed,
    #[tl(id = "consensus.eventKind.invalid")]
    Invalid,
    #[tl(id = "consensus.eventKind.equivocated")]
    Equivocated,
    #[tl(id = "consensus.eventKind.evidenceNoInclusion")]
    EvidenceNoInclusion,
}
...
pub enum EventSeverity {
    ...
    #[tl(id = "consensus.eventSeverity.debug")]
    Debug,
