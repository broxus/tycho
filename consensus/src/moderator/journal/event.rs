    ...
    pub fn action(&self) -> JournalAction {
        ...
        match self {
            ...
            Self::IllFormed(ill) => match ill.reason() {
                IllFormedReason::AfterLoadFromDb => JournalAction::CheckBan, // already stored
            ...
            Self::Invalid(invalid) => match invalid.reason() {
                InvalidReason::AfterLoadFromDb => JournalAction::CheckBan, // already stored
                ...
                | InvalidReason::AnchorLinkBadPath(_) => JournalAction::StoreAndCheckBan,
            },
        }
    }
    ...
    pub fn fill_points<'a>(
        ...
        match self {
            ...
            Self::ReplacedPoint {
                ...
                point_keys.push((requested.round, &requested.digest));
                point_keys.push((received.round, &received.digest));
            }
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::ReplacedPoint {
                ...
                write!(
                    f,
                    "wrong point: requested {:?} received {:?}",
                    requested.alt(),
                    received.alt()
                )
            }
