...
pub struct RecordValue {
    ...
    pub kind: RecordKind,
    pub peer_id: PeerId,
    pub point_refs: Vec<JournalPointRef>,
    #[tl(with = "tl_string")]
    pub message: String,
}
...
#[derive(Debug, PartialEq, Eq, PartialOrd, Ord, TlRead, TlWrite)]
#[tl(boxed, id = "journal.pointRef", scheme = "proto.tl")]
pub struct JournalPointRef {
    pub key: PointKey,
    pub is_stored: bool,
}
...
mod tl_string {
    ...
    pub fn size_hint(item: &str) -> usize {
        tl_proto::bytes_max_size_hint(item.len())
    }
