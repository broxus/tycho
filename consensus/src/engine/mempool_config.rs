...
pub struct MempoolMergedConfig {
    ...
    pub(crate) genesis: Point,
}

#[cfg(feature = "test")]
impl MempoolMergedConfig {
    pub fn conf(&self) -> &MempoolConfig {
        &self.conf
    }
}
    ...
    pub fn build(&self) -> Result<MempoolMergedConfig> {
        ...
        let genesis = Point::new(
            ...
            PointData {
                ...
                time: UnixTime::from_millis(genesis_info.genesis_millis),
                includes: Default::default(),
                witness: Default::default(),
                anchor_trigger: Link::ToSelf,
                anchor_proof: Link::ToSelf,
                anchor_time: UnixTime::from_millis(genesis_info.genesis_millis),
            },
            &mempool_config,
        );
