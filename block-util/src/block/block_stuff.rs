...
#[cfg(test)]
pub fn get_empty_block() -> BlockStuff {
    get_empty_block_with_block_id(BlockId::default())
}

pub fn get_empty_block_with_block_id(block_id: BlockId) -> BlockStuff {
    ...
    BlockStuff::with_block(block_id, block)
}
