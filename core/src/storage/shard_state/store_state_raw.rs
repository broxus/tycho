...
mod test {
    ...
    async fn insert_and_delete_of_several_shards() -> Result<()> {
        let mut __guard = crate::__async_profile_guard__::Guard::new(
            concat!(
                module_path!(),
                "::",
                stringify!(insert_and_delete_of_several_shards)
            ),
            file!(),
            line!(),
        );
        ...
        let storage = {
            __guard.end_section(line!());
            let __result = CoreStorage::open(ctx, CoreStorageConfig {
        ...
        {
            __guard.end_section(line!());
            let __result = states_gc(cell_storage, core_db).await;
            __guard.start_section(line!());
            __result
        }?;
        Ok(())
    ...
    async fn rand_cells_storage() -> Result<()> {
        ...
        {
            __guard.end_section(line!());
            let __result = core_db.trigger_compaction().await;
            __guard.start_section(line!());
            __result
        };
        {
