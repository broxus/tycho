...
impl DescriptorCache {
    ...
    pub fn remove_outdated_cached_states(&self, recent_block_id: &BlockId) -> Result<Vec<BlockId>> {
...
impl Inner {
    ...
    fn remove_outdated_cached_states(&self, recent_block_id: &BlockId) -> Result<Vec<BlockId>> {
