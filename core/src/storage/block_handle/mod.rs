...
impl BlockHandleStorage {
    ...
    pub fn set_skip_states_gc(&self, handle: &BlockHandle) -> bool {
        ...
        if updated {
            ...
            tracing::info!(block_id = %handle.id(), "skip states gc was set");
        }
        updated
    }
    ...
    pub fn set_skip_states_gc_finished(&self, handle: &BlockHandle) -> bool {
        ...
        if updated {
            self.store_handle(handle, false);
            tracing::info!(block_id = %handle.id(), "skip states gc was finished");
        }
        updated
    }
    ...
    pub fn set_skip_blocks_gc(&self, handle: &BlockHandle) -> bool {
        ...
        if updated {
            self.store_handle(handle, false);
            tracing::info!(block_id = %handle.id(), "skip blocks gc was set");
        }
        updated
    }
    ...
    pub fn set_skip_blocks_gc_finished(&self, handle: &BlockHandle) -> bool {
        ...
        if updated {
            self.store_handle(handle, false);
            tracing::info!(block_id = %handle.id(), "skip blocks gc was finished");
        }
        updated
    }
