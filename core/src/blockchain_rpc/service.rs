    ...
    async fn handle_get_block_data_chunk(
        ...
        let mut __guard = crate::__async_profile_guard__::Guard::new(
            concat!(
                module_path!(),
                "::",
                stringify!(handle_get_block_data_chunk)
            ),
            file!(),
            line!(),
        );
    ...
    async fn handle_get_persistent_shard_state_chunk(
        ...
        let mut __guard = crate::__async_profile_guard__::Guard::new(
            concat!(
                module_path!(),
                "::",
                stringify!(handle_get_persistent_shard_state_chunk)
            ),
            file!(),
            line!(),
        );
        {
            __guard.end_section(line!());
            let __result = self
                .read_persistent_state_chunk(&req.block_id, req.offset, PersistentStateKind::Shard)
                .await;
            __guard.start_section(line!());
            __result
        }
    ...
    async fn handle_get_persistent_queue_state_chunk(
        ...
        let mut __guard = crate::__async_profile_guard__::Guard::new(
            concat!(
                module_path!(),
                "::",
                stringify!(handle_get_persistent_queue_state_chunk)
            ),
            file!(),
            line!(),
        );
        {
            __guard.end_section(line!());
            let __result = self
                .read_persistent_state_chunk(&req.block_id, req.offset, PersistentStateKind::Queue)
                .await;
            __guard.start_section(line!());
            __result
        }
    ...
    async fn read_persistent_state_chunk(
        ...
        let mut __guard = crate::__async_profile_guard__::Guard::new(
            concat!(
                module_path!(),
                "::",
                stringify!(read_persistent_state_chunk)
            ),
            file!(),
            line!(),
        );
