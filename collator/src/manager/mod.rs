    ...
    V: Validator,
{
    ...
    async fn sync_to_applied_mc_block(
        ...
        if let Some(mp_cfg_override) = &self.mempool_config_override {
            ...
            if mp_cfg_override.genesis_info.start_round
                >= last_consesus_info.genesis_info.start_round
                && mp_cfg_override.genesis_info.millis > last_consesus_info.genesis_info.millis
            {
                tracing::debug!(target: tracing_targets::COLLATION_MANAGER,
                    prev_genesis_start_round = last_consesus_info.genesis_info.start_round,
                    prev_genesis_time_millis = last_consesus_info.genesis_info.millis,
                    new_genesis_start_round = mp_cfg_override.genesis_info.start_round,
                    new_genesis_time_millis = mp_cfg_override.genesis_info.millis,
