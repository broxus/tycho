...
pub struct ExecuteState<'a, 'b> {
    pub messages_reader: MessagesReader<'a, 'b, EnqueuedMessage>,
...
impl<'a, 'b> PhaseState for ExecuteState<'a, 'b> {}

impl<'a, 'b> Phase<ExecuteState<'a, 'b>> {
    ...
    pub fn finish(
        ...
        Phase<FinalizeState>,
        MessagesReader<'a, 'b, EnqueuedMessage>,
    ) {
