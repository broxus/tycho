...
use super::{DebugMessageGroup, DebugMessagesBuffer, MessageGroupV2, MessagesBufferV2};
...
fn test_message_group_filling_from_buffers() {
    ...
    let mut msg_group = MessageGroupV2::default();
    ...
    int_buffer_par_1.fill_message_group(
        ...
        group_vert_size,
        None,
        |account_id| int_buffer_par_0.msgs.contains_key(account_id),
    );
    println!(
    ...
    ext_buffer_range_2.fill_message_group(
        ...
        group_vert_size + 1,
        None,
        |account_id| ext_buffer_range_1.msgs.contains_key(account_id),
    );
    println!(
    ...
    msg_group = MessageGroupV2::default();
    ...
    // we can append messages from partition 0
    int_buffer_par_0.fill_message_group(
        &mut msg_group,
        group_limit,
        group_vert_size,
        Some(unused_from_par0),
        |_| false,
    );
    println!(
