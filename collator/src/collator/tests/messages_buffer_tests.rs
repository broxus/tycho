...
use crate::collator::messages_buffer::CheckSkipMessage;
...
fn test_message_group_filling_from_buffers() {
    ...
    // dummy msg check
    let do_not_check_skip_msg = CheckSkipMessage::DoNot(|_: &ParsedMessage| false);
    let check_skip_msg = CheckSkipMessage::Check(|_: &ParsedMessage| false);
