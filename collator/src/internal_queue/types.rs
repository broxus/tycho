...
use everscale_types::models::{Addr, IntAddr, IntMsgInfo, Message, MsgInfo, ShardIdent};
...
pub trait InternalMessage: Send + Sync {
    type AddrType: Addr;
    type ValueType: InternalMessageValue;

    fn dest(&self) -> &Self::AddrType;
