...
async fn test_iteration_from_two_shards() -> anyhow::Result<()> {
    let mut __guard = crate::__async_profile_guard__::Guard::new(
        concat!(
            module_path!(),
            "::",
            stringify!(test_iteration_from_two_shards)
        ),
        file!(),
        line!(),
    );
...
async fn test_queue_tail_and_diff_info() -> anyhow::Result<()> {
    let mut __guard = crate::__async_profile_guard__::Guard::new(
        concat!(
            module_path!(),
            "::",
            stringify!(test_queue_tail_and_diff_info)
        ),
        file!(),
        line!(),
    );
...
async fn prepare_data_from_prepared_persistent_state(
    ...
    let mut __guard = crate::__async_profile_guard__::Guard::new(
        concat!(
            module_path!(),
            "::",
            stringify!(prepare_data_from_prepared_persistent_state)
        ),
        file!(),
        line!(),
    );
...
async fn test_import_persistent_state() -> anyhow::Result<()> {
    let mut __guard = crate::__async_profile_guard__::Guard::new(
        concat!(
            module_path!(),
            "::",
            stringify!(test_import_persistent_state)
        ),
        file!(),
        line!(),
    );
