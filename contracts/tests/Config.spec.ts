...
import { Blockchain, createShardAccount, SandboxContract, SmartContract, } from "@ton/sandbox";
...
import { Config, CONFIG_OP_SET_NEXT_VALIDATOR_SET, storeConfigData, } from "../wrappers/Config";
import { bufferToBigInt, ConfigParams, makeStubValidatorSet, simpleInternal, storeValidatorSet, } from "../wrappers/util";
...
describe("Config", () => {
    ...
    let params = new ConfigParams(TychoExecutor.defaultConfig);
