...
impl InternalQueueStorage {
    ...
    pub fn insert_message_session(
        ...
        let dest_workchain = int_addr.workchain() as i8;
        let dest_prefix = int_addr.prefix();
        Self::insert_message(batch, cf, key, dest_workchain, dest_prefix, cell)
    }
    ...
    fn insert_message(
        ...
        buffer.write_raw_slice(&dest_workchain.to_be_bytes());
        buffer.write_raw_slice(&dest_prefix.to_be_bytes());
