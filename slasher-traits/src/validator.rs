...
macro_rules! impl_recorder_for_tuples {
    ...
    (@call_on_anchor_import $self:ident, $sid:ident, $block_id:ident, $anchor_stats:ident, $n:tt $($rest:tt)+) => {
        $self.$n.on_anchor_import($sid, $block_id, $anchor_stats.clone());
        impl_recorder_for_tuples!(@call_on_anchor_import $self, $sid, $block_id, $anchor_stats, $($rest)+)
    };
    ...
    (@call_on_anchor_import $self:ident, $sid:ident, $block_id:ident, $anchor_stats:ident, $n:tt) => {
        $self.$n.on_anchor_import($sid, $block_id, $anchor_stats);
    };
